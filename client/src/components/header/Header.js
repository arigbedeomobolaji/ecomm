        ...
        !!userInfo ? (
          <div className="dropdown">
            ...
            <div className="dropdown__body">
              <Link className="header__link" to='/orderhistory'>Order history</Link>
              <Link className="header__link" to='/profile'>User Profile</Link>
              <Link className="header__link" to="" onClick={handleSignout}>Sign out</Link>
            </div>
          </div>
        ) :  (
          <div>
